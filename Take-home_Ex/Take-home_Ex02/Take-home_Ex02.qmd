...
```{r}
pacman::p_load(sf, tmap, tidyverse, sfdep, ggplot2, e1071)
```
...
## 4.2 Visualising Lisa Map

LISA map is a categorical map showing outliers and clusters. Below are the different types:
...
```{r}
skewness(lisa_2017$p_ii_sim, na.rm = TRUE)
skewness(lisa_2018$p_ii_sim, na.rm = TRUE)
skewness(lisa_2019$p_ii_sim, na.rm = TRUE)
skewness(lisa_2020$p_ii_sim, na.rm = TRUE)
skewness(lisa_2021$p_ii_sim, na.rm = TRUE)
skewness(lisa_2022$p_ii_sim, na.rm = TRUE)

mean(lisa_2017$skewness, na.rm = TRUE)
mean(lisa_2018$skewness, na.rm = TRUE)
mean(lisa_2019$skewness, na.rm = TRUE)
mean(lisa_2020$skewness, na.rm = TRUE)
mean(lisa_2021$skewness, na.rm = TRUE)
mean(lisa_2022$skewness, na.rm = TRUE)
