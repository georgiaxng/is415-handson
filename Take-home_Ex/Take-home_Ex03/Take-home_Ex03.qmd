...
For the choropleth map, the user will be given the options to:
...
::: callout-note
Note: As Kallang/Whampoa does not match any towns in `mpsz_sf`, we will map it to Kallang. On the other hand for the town 'Central', since we are not able to make any deduction based on this naming and it also does not match any values in `mpsz_sf`, we can only remove it from the choropleth mapping.
:::
...
-   Plot Variable: Geospatial data including Kindergarten, Primary School etc
...
![](images/clipboard-2346678178.png)

### 10.1.2 Categorical

![](images/clipboard-1728895008.png)

## 10.2 Choropleth Map

![](images/clipboard-2622783023.png)

## 10.3 Scatterplot

![](images/clipboard-1900428479.png)
