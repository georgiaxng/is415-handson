...
The main focus of the topic for these hands-on exercises are thematic/choropleth mapping and other geospatial visualization techniques.
...
-   <div>
    ...
    >
    >     -   `YOUNG`: Sum selected columns for young age groups (columns 3-6 and 12).
    >
    >     -   `ECONOMY ACTIVE`: Sum columns for economically active groups (columns 7-11 and 13-15).
    >
